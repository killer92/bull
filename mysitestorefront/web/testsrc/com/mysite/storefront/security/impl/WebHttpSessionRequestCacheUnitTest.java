...
public class WebHttpSessionRequestCacheUnitTest
{
	...
	public void testCalcRedirectUrlWithEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/mysitestorefront/electronics/en",
						"https://electronics.local:9002/mysitestorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/mysitestorefront/electronics/en",
						"https://electronics.local:9002/mysitestorefront/electronics/en/"));
	...
	public void testCalcRedirectUrlWithMismatchEncodingAttrs()
	{
		assertEquals(
				"electronics/en",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/mysitestorefront/electronics/ja/Y/Z",
						"https://electronics.local:9002/mysitestorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/mysitestorefront/electronics/en",
						"https://electronics.local:9002/mysitestorefront/electronics/en/"));
	}
	...
	public void testCalcRedirectUrlWithoutEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/mysitestorefront",
						"https://electronics.local:9002/mysitestorefront"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/mysitestorefront",
						"https://electronics.local:9002/mysitestorefront/"));
	...
	public void testCalcRedirectUrlWithEncodingAttrsServletPath()
	{
		assertEquals(
				...
				executeCalculateRelativeRedirectUrl("electronics/en", "/mysitestorefront/electronics/en",
						"https://electronics.local:9002/mysitestorefront/electronics/en/Open-Catalogue/Cameras/Digital-Cameras/c/575"));
	}

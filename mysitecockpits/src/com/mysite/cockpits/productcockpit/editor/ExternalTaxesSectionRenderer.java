 ...
 *
 */
package com.mysite.cockpits.productcockpit.editor;
			...
			if (section instanceof CustomEditorSection)
			{
				...
				if (customSection.getSectionConfiguration() instanceof ExternalTaxesSectionConfiguration)
				{
					...
					if (secConfig != null)
					{
						...
						final Label rowLabel = new Label(Labels.getLabel("mysitecockpits.product.externalTaxes"));
						rowLabel.setTooltiptext(Labels.getLabel("mysitecockpits.product.externalTaxes"));

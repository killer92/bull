 ...
 *
 */
package com.mysite.cockpits.setup;
...
import com.mysite.cockpits.constants.MysiteCockpitsConstants;
 ...
 */
@SystemSetup(extension = MysiteCockpitsConstants.EXTENSIONNAME)
public class CockpitSystemSetup extends AbstractSystemSetup
{
	...
	public void createEssentialData(final SystemSetupContext context)
	{
		...
		{
			if (MediaManager.getInstance().getMediaFolderByQualifier(MysiteCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER).size() < 1)
			{
				MediaManager.getInstance().createMediaFolder(MysiteCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER,
						MysiteCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER);
			}
			try
			{
				String prefix = null;
				...
				if (prefix != null){
					importImpexFile(context, "/mysitecockpits/reportcockpit/import/" + prefix + "_jasperreports.impex");
				}
			}

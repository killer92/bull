...
import com.mysite.test.constants.MysiteTestConstants;
import com.mysite.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = MysiteTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/mysitetest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/mysitetest/import/reviews.impex");
			...
			importImpexFile(context, "/mysitetest/import/cstickets.impex");
		}
	}
}
